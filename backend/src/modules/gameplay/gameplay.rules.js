 ...
 */
const calculateCricketFantasyPoints = ({ stats, matchType = 'T20', config = {} }) => {
  ...
  if (type !== 'TEST' && ballsBowled >= minBalls) {
    ...
    if (type === 'T10') {
      if      (econ <= 3.90)                        points += 4;
      else if (econ >= 4.00  && econ <= 4.90)       points += 3;
      else if (econ >= 5.00  && econ <= 5.90)       points += 2;
      else if (econ >= 10.00 && econ <= 11.00)      points -= 2;
      else if (econ >= 11.10 && econ <= 12.00)      points -= 3;
      else if (econ >= 12.10)                       points -= 4;
    } else {
      // T20 & ODI share the same economy bands
      if      (econ <= 3.90)                        points += 6;
      else if (econ >= 4.00  && econ <= 4.90)       points += 4;
      else if (econ >= 5.00  && econ <= 5.90)       points += 2;
      else if (econ >= 10.00 && econ <= 11.00)      points -= 2;
      else if (econ >= 11.10 && econ <= 12.00)      points -= 4;
      else if (econ >= 12.10)                       points -= 6;
    }
  }
